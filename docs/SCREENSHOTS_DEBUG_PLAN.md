...
| 2026-09-03 17:53Z | ios-appstore-release (run 33787249898) | `ca117b0` | retry welcome->login across relaunch | 13 s (launch to session) | `welcome-login-button` not found after 60s; PID 60338→63632 (relaunch) | H1+H5 | No `.ips`; app relaunched, login screen never appeared |
| 2026-09-03 18:34Z | ios-appstore-release (run 33791327297) | `36fc176` | ci: upload simulator crash reports | 17 s | `login-email` not found; PID 54772→58154 (relaunch) | H1+H5 | No `.ips`; login screen never appeared after relaunch |
| 2026-09-03 19:47Z | ios-appstore-release (run 33798534752) | `30b6384` | longer settle + more tap retries | 13 s | `login-email` not found; PID 61266→66915 (relaunch) | H1+H5 | No `.ips`; same pattern |
| 2026-09-03 20:33Z | ios-appstore-release (run 33802997305) | `b424829` | detect sign-in via LOG IN title | 124 s (!) launch to session | `login-email` not found after LOG IN appeared; PID 57230→61985 | H1b+H5 | LOG IN title found but email field not in AX tree; 124s startup |
| 2026-09-03 21:16Z | ios-appstore-release (run 33807052977) | `9a5662c` | find email/password by type | 16 s | `app.textFields.firstMatch` failed (email field not in AX tree); PID 60829→66010 | **H1b** | LOG IN found, FloatingLabelInput's TextInput not exposed as .textField AX type |
